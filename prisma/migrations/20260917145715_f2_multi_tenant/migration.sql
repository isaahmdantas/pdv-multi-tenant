...
CREATE TABLE "Role" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "globalStoreAccess" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "UserStore_tenantId_storeId_idx" ON "UserStore"("tenantId", "storeId");

-- CreateIndex
CREATE UNIQUE INDEX "UserStore_tenantId_userId_storeId_key" ON "UserStore"("tenantId", "userId", "storeId");
...
-- AddForeignKey
ALTER TABLE "UserStore" ADD CONSTRAINT "UserStore_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserStore" ADD CONSTRAINT "UserStore_storeRoleId_fkey" FOREIGN KEY ("storeRoleId") REFERENCES "Role"("id") ON DELETE SET NULL ON UPDATE CASCADE;
